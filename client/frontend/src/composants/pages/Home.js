...
const Home = () => {
	...
	const addToCart = (marketing) => {
		const newItem = {
		  id: marketing.id_produit,
		  name: marketing.nom_produit,
		  price: marketing.prix_produit,
		  quantity: 1
		};
        ...
        <section className="w3l-grids-hny-2">
			<div className="grids-hny-2-mian py-5">
				<div className="container py-lg-5">
					...
					<div></div>
					{/* je cree une boucle qui affiche les categorie */}
					<div className="welcome-grids row mt-5">
						<div className="col-lg-2 col-md-4 col-6 welcome-image">
								...
								<h4><Link to="/Home_list">Hand Bags</Link></h4>
			...
			<div className="ecom-contenthny py-5">
				<div className="container py-lg-5">
					...
					{Marketing.map((marketing) => (
						<div className="col-lg-3 col-6 product-incfhny mt-4" key={marketing.id_produit}>
							<div className="product-grid2 transmitv">
								<div className="product-image2">
									<Link to={`/Home_detail/${marketing.id_produit}`}>
										<img className="pic-1 img-fluid" src={marketing.image_produit}/>
										<img className="pic-2 img-fluid" src={marketing.image_produit}/>
									</Link>
									<ul className="social">
											<li><Link to={`/Home_detail/${marketing.id}`} data-tip="Quick View"><span className="fa fa-eye"></span></Link></li>

											<li><Link to="#" data-tip="Add to Cart"><span className="fa fa-shopping-bag"></span></Link>
											</li>
									</ul>
								...
								<div className="product-content">
									<h3 className="title"><Link to={`/Home_detail/${marketing.id}`}>{marketing.nom_produit}</Link></h3>
									<span className="price"><del>{marketing.ancien_prix_produit}</del>{marketing.prix_produit} XAF</span>
								</div>
							</div>
						</div>
					 ))}
